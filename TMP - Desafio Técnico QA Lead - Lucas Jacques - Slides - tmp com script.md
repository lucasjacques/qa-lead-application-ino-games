...
<span style="font-size: 13px; letter-spacing: 3px; display: block; margin-top: 6px; margin-right: 15px;">QA🔬</span>
...
# O cenário em números *(Q1)*

<br>

| 🐛 **28** | 🚨 **9** |
|:---:|:---:|
| bugs críticos encontrados após freeze | escaparam para produção |

| ⏰ **40%** | 🔧 **3 dias** |
|:---:|:---:|
| dos bugs detectados próximo ao release | tempo médio de correção |

<br>

> O time está testando tarde demais, sem cobertura estruturada.

<span style="color:red">**[RASCUNHO — considerar gráfico de barra ou visual de impacto]**</span>
...
### Decisão imediata necessária *(Q7)*
...
# 🚨 Bug crítico: como estamos respondendo *(Q7)*
...
# Antecipando bugs: novo fluxo *(Q3)*
...
# Plano de ação: próximas 2 semanas *(Q1)*
